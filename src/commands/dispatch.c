...
static const CommandEntry command_table[] = {
    ...
    {"MODE", command_mode}, {"MOTD", command_motd}, {"NAMES", command_names},
    {"NICK", command_nick}, {"NICKSERV", command_nickserv}, {"NOTICE", command_notice},
    {"NSDROP", command_nsdrop}, {"NSINFO", command_nsinfo}, {"NSSET", command_nsset},
    ...
    {"SETNAME", command_setname}, {"TOPIC", command_topic}, {"USER", command_user},
