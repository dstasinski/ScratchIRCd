...
static const CommandEntry command_table[] = {
    ...
    {"DEAF", command_deaf}, {"DIE", command_die}, {"GEOBAN", command_geoban},
    {"GLOBOPS", command_globops}, {"IDENTIFY", command_identify},
    {"INVITE", command_invite}, {"ISON", command_ison}, {"JOIN", command_join},
    {"KICK", command_kick}, {"KILL", command_kill}, {"KLINE", command_kline},
    {"KNOCK", command_knock}, {"LIST", command_list}, {"LOCOPS", command_locops},
    {"LUSERS", command_lusers}, {"MEMOSERV", command_memoserv}, {"MODE", command_mode},
    {"MOTD", command_motd}, {"MSINFO", command_msinfo}, {"MSPURGE", command_mspurge},
    {"MUTE", command_mute}, {"NAMES", command_names}, {"NICK", command_nick},
    ...
    {"OPERADD", command_operadd}, {"OPERDEL", command_operdel},
    ...
    {"SAPART", command_sapart}, {"SETHOST", command_sethost}, {"SETIDENT", command_setident},
    {"SETNAME", command_setname}, {"SILENCE", command_silence}, {"TOPIC", command_topic},
    {"UNGEOBAN", command_ungeoban}, {"USER", command_user}, {"USERHOST", command_userhost},
