...
static const CommandEntry command_table[] = {
    {"ADMIN", command_admin}, {"AWAY", command_away}, {"IDENTIFY", command_identify},
    ...
    {"NICKSERV", command_nickserv}, {"NOTICE", command_notice},
    ...
    {"OPERLIST", command_operlist}, {"OPERSET", command_operset},
