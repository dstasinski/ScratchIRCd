...
int server_reassign_client_id(Server *server,Client *client){
    ...
    uint64_t new_id;
    if(server==NULL||client==NULL||server->next_client_id==UINT64_MAX)return -1;
