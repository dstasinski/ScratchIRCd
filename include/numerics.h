...
#define ERR_NOADMININFO  ":%s 423 %s %s :No administrative info"
#define ERR_FILEERROR  ":%s 424 %s :File error: %s"
...
#define ERR_NOCHANMODES  ":%s 477 %s %s :Channel doesn't support modes"
...
#define ERR_RESTRICTED  ":%s 484 %s :Your connection is restricted!"
#define ERR_UNIQOPPRIVSNEEDED  ":%s 485 %s :You're not the original channel operator"
...
#define RPL_LOGON  ":%s 600 %s %s %s %s %lu :logged online"
#define RPL_LOGOFF  ":%s 601 %s %s %s %s %lu :logged offline"
#define RPL_WATCHOFF  ":%s 602 %s %s %s %lu :stopped watching"
#define RPL_WATCHSTAT  ":%s 603 %s %s %s %s %lu :is %s"
#define RPL_NOWON  ":%s 604 %s %s %s %s %lu :is online"
#define RPL_NOWOFF  ":%s 605 %s %s %s %s %lu :is offline"
#define RPL_WATCHLIST  ":%s 606 %s :%s"
#define RPL_ENDOFWATCHLIST  ":%s 607 %s :End of WATCH list"
