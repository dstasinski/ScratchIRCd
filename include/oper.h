...
#define OPER_PERMISSION_ELINE     (UINT64_C(1) << 13)
#define OPER_PERMISSION_STATS     (UINT64_C(1) << 14)
...
#define OPER_PERMISSION_ALL \
    (OPER_PERMISSION_REHASH | OPER_PERMISSION_DIE | OPER_PERMISSION_RESTART | \
     ...
     OPER_PERMISSION_GEOBAN | OPER_PERMISSION_ELINE | OPER_PERMISSION_STATS)
