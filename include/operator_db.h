 ...
 *
 * Ordinary IRC operators are persisted in operators.db. The bootstrap network
 * administrator remains in ircd.conf so a fresh installation always has a
 * recovery path even when the operator database is empty or damaged.
 */
