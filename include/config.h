...
/* PING-cookie anti-spoofing and client CTCP metadata probes. */
...
/* Runtime IRC presence/list limits. */
...
#define IRCD_ISUPPORT_BASE \
    "CASEMAPPING=rfc1459 CHANTYPES=#& PREFIX=(qaohv)~&@%+ NICKLEN=31 CHANNELLEN=63 MSGREFTYPES=timestamp WATCH=128 SILENCE=64"
